...
function createMessage(dep) {
  ...
  var diff = dep.diff.reduce(function (init, diff) {
    ...
    return '' + init + _get__('chalk').bold[color](diff.value);
  }, '');
...
var _typeOfOriginalExport = typeof createMessage === 'undefined' ? 'undefined' : (0, _typeof3.default)(createMessage);

function addNonEnumerableProperty(name, value) {
  (0, _defineProperty2.default)(createMessage, name, {
    value: value,
    enumerable: false,
    configurable: true
  });
...
if ((_typeOfOriginalExport === 'object' || _typeOfOriginalExport === 'function') && (0, _isExtensible2.default)(createMessage)) {
