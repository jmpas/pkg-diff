...
function diff() {
  ...
  return _get__('diffChars')(value1, value2);
}
...
function getDiff(obj1, obj2) {
  ...
  return allProps.reduce(function (props, prop) {
    ...
    return {
      name: prop,
      diff: _get__('diff')(obj1[prop], obj2[prop]),
      left: obj1[prop],
      right: obj2[prop]
    };
  });
...
var _typeOfOriginalExport = typeof getDiff === 'undefined' ? 'undefined' : (0, _typeof3.default)(getDiff);

function addNonEnumerableProperty(name, value) {
  (0, _defineProperty2.default)(getDiff, name, {
    value: value,
    enumerable: false,
    configurable: true
  });
...
if ((_typeOfOriginalExport === 'object' || _typeOfOriginalExport === 'function') && (0, _isExtensible2.default)(getDiff)) {
