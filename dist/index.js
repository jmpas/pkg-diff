...
var argv = _get__('minimist')(process.argv.slice(2));

var deps = _get__('getDiff')(_get__('getDependencies')(_get__('argv')._[0], _get__('argv').ignore), _get__('getDependencies')(_get__('argv')._[1], _get__('argv').ignore));

_get__('deps').map(_get__('createMessage')).forEach(function (msg) {
...
function _get_original__(variableName) {
  switch (variableName) {
    ...
    case 'getDiff':
      return _getDiff2.default;

    case 'getDependencies':
      return _getDependencies2.default;
    ...
    case 'createMessage':
      return _createMessage2.default;
  }
